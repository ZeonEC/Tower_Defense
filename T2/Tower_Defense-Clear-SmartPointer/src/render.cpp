...
void RenderControl::drawContent() {
    switch (activeTab) {
        case 0:{
            std::ostringstream oss;
            oss << "Gestion des Tourelles\n\n";
            oss << "[A] Basic      " << BasicTourelle(0.f).getCost()   << " or\n";
            oss << "[Z] Poison     " << PoisonTourelle(0.f).getCost() << " or\n";
            oss << "[E] Shotgun    " << shotgunTourelle(0.f).getCost() << " or\n";
            oss << "[R] Target     " << TargetTourelle(0.f).getCost()  << " or\n";
            oss << "[T] Fly        " << FlyTourelle(0.f).getCost()    << " or";
...
void RenderControl::displayFull() {
    clear();
    drawTabs();
    drawContent();
    display();
